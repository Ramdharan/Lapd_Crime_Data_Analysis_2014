...
from (
  ...
  join location_values on lapd_crime_data.dr_no=location_values.dr_no where location_values.distance>10 and location_values.distance is not null) lapd_crime_data
