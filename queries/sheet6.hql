...
from (
  ...
  select case  
	...
	join location_values on lapd_crime_data.dr_no=location_values.dr_no
   where lapd_crime_data.area_name ='Hollenbeck' and location_values.distance  between 0 and 5) lapd_crime_data
