...
from (
  ...
  join location_values on lapd_crime_data.dr_no=location_values.dr_no where location_values.distance  between 0 and 5 and  lapd_crime_data.time_occ between 1600 and 2000 ) lapd_crime_data  
